...
public class User implements Runnable {
    ...
    public void run() {
        ...
        myLock.lock();
        // 执行现金业务
        System.out.println(name + "正在操作" + myAccount + "账户，金额为" + iocash + "，当前金额为" + myAccount.getCash());
        myAccount.setCash(myAccount.getCash() + iocash);
        System.out.println(name + "操作" + myAccount + "账户成功，金额为" + iocash + "，当前金额为" + myAccount.getCash());
        // 释放锁，否则别的线程没有机会执行了
        myLock.unlock();
    }
