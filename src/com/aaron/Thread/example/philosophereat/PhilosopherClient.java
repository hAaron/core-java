...
class Chopstick {
    ...
    public synchronized void takeChopstick(String name) {
        ...
        int i = name.contains("A") ? 0 : (name.contains("B") ? 1
            : (name.contains("C") ? 2 : (name.contains("D") ? 3 : (name.contains("E") ? 4 : -1))));
    ...
    public synchronized void putChopstick(String name) {
        int i = name.contains("A") ? 0 : (name.contains("B") ? 1
            : (name.contains("C") ? 2 : (name.contains("D") ? 3 : (name.contains("E") ? 4 : -1))));// Integer.parseInt(name);
        used[i] = false;
        used[(i + 1) % 5] = false;
