...
public class MemcachedTest {
     ...
     */
    public static void incrDecrMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数字值
        ...
        // 自增并输出
        System.out.println("value in cache after increment - " + client.incr("number", 111));

        // 自减并输出
        System.out.println("value in cache after decrement - " + client.decr("number", 112));
    }
     ...
     * @throws ExecutionException
     */
    public static void deleteMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数据
        Future fo = client.set("keys", 900, "World's largest online tutorials library");
        ...
        // 获取键对应的值
        System.out.println("keys value in cache - " + client.get("codingground"));
    }
     ...
     * @throws ExecutionException
     */
    public static void getsCASMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数据
     ...
     * @throws ExecutionException
     */
    public static void getMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数据
        Future fo = client.set("keys", 900, "Free Education");
     ...
     * @throws ExecutionException
     */
    public static void CASMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数据
        ...
        // 尝试使用cas方法来更新数据
        CASResponse casresp = client.cas("keys", casValue.getCas(), 900, "Largest Tutorials-Library");
     ...
     * @throws ExecutionException
     */
    public static void prependMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数据
     ...
     * @throws ExecutionException
     */
    public static void appendMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        getMemcached(client);
     ...
     * @throws ExecutionException
     */
    public static void replaceMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加第一个 key=》value 对
     ...
     * @throws ExecutionException
     */
    public static void addMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 添加数据
        ...
        // 输出
        System.out.println("codingground value in cache - " + client.get("codingground"));
    }
     ...
     * @throws ExecutionException
     */
    public static void setMemcached(MemcachedClient client) throws InterruptedException, ExecutionException {
        // 存储数据
