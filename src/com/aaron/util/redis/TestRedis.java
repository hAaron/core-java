...
public class TestRedis {
    ...
    public void testString() {
        ...
        jedis.incr("age");
        System.out.println("设置多个键值对:" + jedis.get("name") + "-" + jedis.get("age") + "-" + jedis.get("tel"));
    }
    ...
    public void testMap() {
        ...
        while (iterator.hasNext()) {
            ...
            System.out.println("遍历结果集==" + key + ":" + jedis.hmget("user", key));
        }
    }
    ...
    public void testList() {
        ...
        System.out.println("取出key为java framework" + jedis.lrange("java framework", 0, -1));
