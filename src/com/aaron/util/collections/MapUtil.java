...
public class MapUtil {
    ...
    /**
     * 将一个List<Map<String,Object>> 的集合包装成 Map<String,List<Map<String,Object>>> 比如 时间=List<Map<String,Object>> 格式
     * 
     * @param datas
     ...
     * @return
     */
    public static Map<String, List<Map<String, Object>>> build(List<Map<String, Object>> datas, Object key) {
