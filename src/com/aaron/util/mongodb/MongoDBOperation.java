...
public class MongoDBOperation {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            // 安全认证模式
            MongoClientURI uri =
                new MongoClientURI("mongodb://testuser:1234@192.168.128.131:27017/test_db2?authSource=test_db2");
    ...
    public static void insertCollection(MongoClient mongoClient) {
        ...
        Document document1 =
            new Document("_id", 1999).append("title", "MongoDB Insert Demo").append("description", "database")
                .append("likes", 30).append("by", "yiibai point").append("url", "http://www.yiibai.com/mongodb/");
        Document document2 =
            new Document("_id", 2000).append("title", "MongoDB insertMany Demo").append("description", "database")
                .append("likes", 30).append("by", "test_db2").append("url", "http://www.baidu.com");
