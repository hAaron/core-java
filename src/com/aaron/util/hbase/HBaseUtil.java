...
public class HBaseUtil {
	...
	static {
		...
		hbase_Configuration.set("hbase.zookeeper.quorum",
				"YP526F7-C01-XNFX-DATANODE02");
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (isExist(tableName)) {
				...
				HBaseUtil
						.addRow(tableName,
								"<span style=\"font-family: Arial, Helvetica, sans-serif;\">henjun</span>",
								"info", "sex", "boy");
				...
				HBaseUtil
						.addRow(tableName,
								"<span style=\"font-family: Arial, Helvetica, sans-serif;\">niaopeng</span>",
								"info", "sex", "girl");
				HBaseUtil.addRow(tableName, "niaopeng", "course", "china",
						"100");
				HBaseUtil
						.addRow(tableName, "niaopeng", "course", "math", "100");
				HBaseUtil.addRow(tableName, "niaopeng", "course", "english",
						"99");
				// 第三步：获取一条数据
