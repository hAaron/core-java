 ...
 * @date 2021/11/15
 */
public class LC00030_FindSubstring {
    public static void main(String[] args) {
        String s = "aaaaa";
        String[] words = new String[] {"bba"};
        LC00030_FindSubstring name = new LC00030_FindSubstring();
        System.out.println(name.findSubstring(s, words));
    }
